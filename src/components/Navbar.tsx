    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-card/80 backdrop-blur-md border-b border-border">
            ...
            {moreOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-60 bg-card border border-border rounded-xl elegant-shadow-lg z-50 py-2 overflow-hidden">
                  ...
                  <DropdownItem icon={<Users size={16} />} label="Community" desc="Group discussions" onClick={() => { navigate("/community"); setMoreOpen(false); }} />
                  ...
                  <DropdownItem icon={<Trophy size={16} />} label="Challenges" desc="Daily & monthly quests" onClick={() => { navigate("/challenges"); setMoreOpen(false); }} />
                </div>
              </>
            )}
          </div>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border bg-card px-6 py-4 space-y-1">
          ...
          <MobileItem icon={<Users size={16} />} label="Community" onClick={() => { navigate("/community"); setMobileOpen(false); }} />
